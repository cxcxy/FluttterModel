...
//接收消息监听
  void receiveMessage() {
    messageChannel.setMessageHandler((result) async {
      ...
      // Provider.of<BillInfoModel>(context).setTmpValue(result);

      var cart = context.read<BillInfoModel>();
      //  print(cart);
      print('cart===$cart');
      cart.setTmpValue(result);
